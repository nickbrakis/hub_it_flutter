              ...
              children: [
                Row(
                  children: [
                    ...
                    const IconButton(onPressed: null, icon: Icon(Icons.edit), color: Colors.teal)
                  ],
                ),
...
//dummy owned hubs
final myownedhub1 = Hub(title: "MyHub", enabled: true, habbits: ["Work", "Study", "Cook"]);
final myownedhub2 = Hub(title: "MyHub2", enabled: true, habbits: ["Read a Book", "Go for a Walk", "Meditate"]);
